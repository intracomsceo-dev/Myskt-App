...
const DEFAULT_DEVICES: SktDevice[] = [
  ...
  { id: 'dev-1773351295024', name: '갤럭시 S26 (256GB)', price: 1254000, category: 's-series', order: 11 },
  { id: 'dev-1773351313896', name: '갤럭시 S26 (512GB)', price: 1507000, category: 's-series', order: 12 },
  { id: 'dev-1773351325464', name: '갤럭시 S26 플러스 (256GB)', price: 1452000, category: 's-series', order: 13 },
  { id: 'dev-1773351341399', name: '갤럭시 S26 플러스 (512GB)', price: 1705000, category: 's-series', order: 14 },
  { id: 'dev-1773351360511', name: '갤럭시 S26 울트라 (256GB)', price: 1797400, category: 's-series', order: 15 },
  { id: 'dev-1773351373759', name: '갤럭시 S26 울트라 (512GB)', price: 2050400, category: 's-series', order: 16 },

  { id: 'dev-1767916109151', name: '갤럭시 S25 FE (256GB)', price: 946000, category: 's-series', order: 20 },
  { id: 's25-base', name: '갤럭시 S25 (256GB)', price: 1155000, category: 's-series', order: 21 },
  { id: 'dev-1767915712564', name: '갤럭시 S25 (512GB)', price: 1298000, category: 's-series', order: 22 },
  { id: 's25-plus', name: '갤럭시 S25 플러스 (256GB)', price: 1353000, category: 's-series', order: 23 },
  { id: 'dev-1767915766460', name: '갤럭시 S25 플러스 (512GB)', price: 1474000, category: 's-series', order: 24 },
  { id: 'dev-1767916003353', name: '갤럭시 S25 울트라 (256GB)', price: 1698400, category: 's-series', order: 25 },
  { id: 's25-ultra', name: '갤럭시 S25 울트라 (512GB)', price: 1841400, category: 's-series', order: 26 },
  { id: 'dev-1767917169762', name: '갤럭시 S25 엣지 (256GB)', price: 1496000, category: 's-series', order: 27 },
  { id: 'dev-1767917190001', name: '갤럭시 S25 엣지 (512GB)', price: 1639000, category: 's-series', order: 28 },

  { id: 'dev-1767916167575', name: '갤럭시 퀀텀6', price: 618200, category: 'a-series', order: 32 },
  { id: 'dev-1767916206734', name: '갤럭시 와이드8 (128GB)', price: 374000, category: 'a-series', order: 33 },
      ...
      <header className="bg-white border-b-4 border-[#E2000F] px-6 py-6 sticky top-0 z-40 shadow-md">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-black text-slate-900 tracking-tight">SKT 요금 계산기</h1>
          ...
          {isAdmin && (
            <div className="flex gap-2">
               <button 
                 ...
                 disabled={isSaving}
                 className={`px-6 py-3 rounded-2xl text-sm font-black text-white transition-all shadow-lg ${isSaving ? 'bg-slate-400 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700'}`}
               >
                 {isSaving ? <><i className="fas fa-spinner fa-spin mr-2"></i>저장 중...</> : '데이터 저장'}
               </button>
            ...
            <div className="p-6 bg-slate-50 border-t-2 border-slate-200 flex justify-end">
              ...
              <div className="text-center pt-4 flex justify-center gap-4">
                  <button 
                    onClick={handleManualSave} 
                    disabled={isSaving}
                    className={`px-8 py-4 text-white rounded-2xl font-black transition-all shadow-lg flex items-center gap-2 ${isSaving ? 'bg-slate-400 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700'}`}
                  >
                    {isSaving ? <i className="fas fa-spinner fa-spin"></i> : <i className="fas fa-save"></i>}
                    {isSaving ? '저장 중...' : '현재 설정 저장'}
                  </button>
                  <button onClick={syncWithSource} className="px-8 py-4 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-2xl font-black transition-all flex items-center gap-2 border-2 border-blue-100"><i className="fas fa-sync-alt"></i> 소스 코드와 동기화</button>
